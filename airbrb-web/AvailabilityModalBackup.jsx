...
export default function AvailabilityModal (props) {
  ...
  console.log(props.listingInfo);

  React.useEffect(() => {
    if (props.listingInfo) {
      setChipData(props.listingInfo.availability);
    }
  }, []);

  const updateListingInfo = () => {
    const newListingInfo = [...props.listingInfo];
    props.setListingInfo = newListingInfo;
  }
